...
@section('content')
    <div x-data="{ 
        ...
        <div class="flex items-center justify-between mb-6">
            <p class="text-sm text-gray-500 hidden sm:block">Manage top-level church classifications</p>
                ...
                <table class="w-full text-sm min-w-[600px]">
                    <thead class="bg-gray-50 dark:bg-slate-800/50">
                        <tr>
                            ...
                            <th class="px-3 sm:px-6 py-3 text-left font-medium text-gray-500 dark:text-slate-400">Zonal
                                Pastor</th>
                            <th class="px-3 sm:px-6 py-3 text-center font-medium text-gray-500 dark:text-slate-400">Groups
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-slate-800">
                        @forelse($categories as $i => $category)
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <td class="px-3 sm:px-6 py-3 font-medium text-gray-900 dark:text-white">{{ $category->name }}
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-3 sm:px-6 py-8 text-center text-gray-400 dark:text-slate-500">No
                                    categories found.
                                    Create one to get
                                    started.</td>
                            </tr>
