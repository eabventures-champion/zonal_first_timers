        ...
        <div
            ...
            <div class="flex flex-col lg:flex-row items-center gap-4">
                <div class="relative flex-1 w-full">
                    ...
                    <input type="text" x-model="search" placeholder="Search by name, email, phone, or church..."
                ...
                <div class="flex items-center gap-3 w-full lg:w-auto">
                    <select x-model="selectedRole"
                        ...
                        <option value="Retaining Officer">Retaining Officer</option>
                    </select>
                    ...
                    <select x-model="selectedStatus"
                        ...
                        <option value="retained">Retained Member</option>
                    </select>
                        ...
                        <table class="w-full text-sm min-w-[700px]">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-slate-800">
                                @forelse($users as $user)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors" x-show="shouldShowUser(@js([
                                        'name' => $user->name,
                                        'email' => $user->email,
                                        'phone' => $user->phone,
                                        'church' => $user->church->name ?? '',
                                        'roles' => $user->roles->pluck('name')->toArray(),
                                        'is_ft' => $user->firstTimer && !$user->firstTimer->membership_approved_at,
                                        'is_retained' => (bool) $user->member
                                    ]))">
                                        <td class="px-6 py-3">
                                            @if($user->id !== auth()->id())
                                        ...
                                        <td class="px-6 py-3">
                                            ...
                                            <div class="text-xs text-gray-400 dark:text-slate-500">{{ $user->phone ?? '' }}
                                            </div>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-8 text-center text-gray-400 dark:text-slate-500">No users
                                            found.
                                        </td>
                                    </tr>
                                @endforelse
