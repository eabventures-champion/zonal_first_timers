            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-slate-800/50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left font-medium text-gray-500 dark:text-slate-400">Pastor Details</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-slate-800">
                    @forelse($groups as $i => $group)
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
                            ...
                            <td class="px-6 py-3">
                                <div class="text-gray-900 dark:text-white font-medium">{{ $group->pastor_name ?? '—' }}</div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-400 dark:text-slate-500">No groups found.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
