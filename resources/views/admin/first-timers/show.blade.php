            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <dd class="font-medium text-gray-900 dark:text-slate-200">{{ $firstTimer->email }}</dd>
                    </div>
                    <div>
                        <dt class="text-gray-500 dark:text-slate-500">Primary Contact</dt>
                        <dd class="font-medium text-gray-900 dark:text-slate-200">{{ $firstTimer->primary_contact }}</dd>
                    </div>
                    <div>
