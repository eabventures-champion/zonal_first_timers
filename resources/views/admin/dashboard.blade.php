                ...
                <div class="flex items-center gap-3" x-data="{ editingTarget: false }">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false"
                            ...
                            <span>{{ collect(['this_month' => 'This Month', 'last_6_months' => 'Last 6 Months', 'this_year' => 'This Year', 'last_year' => 'Last Year'])->get(request('trend_period', 'last_6_months')) }}</span>
                        ...
                        <div x-show="open" x-transition
                            ...
                            <a href="{{ route('admin.dashboard', ['trend_period' => 'this_month']) }}"
                        ...
                        tooltip: {
                            ...
                            y: {
                                formatter: function (val, { series, seriesIndex, dataPointIndex, w }) {
                                    ...
                                    const percentage = ((safeVal / targetValue) * 100).toFixed(1);
                                    return `<span style="color: #eab308; font-weight: 600;">${safeVal} out of ${targetValue} (${percentage}%)</span>`;
                                }
                            }
                        },
                        legend: {
