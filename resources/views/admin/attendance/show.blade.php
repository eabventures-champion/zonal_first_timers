            ...
            <nav class="flex mb-2" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('admin.attendance.index') }}" class="text-xs font-medium text-gray-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-white">
                            Attendance
                        </a>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-xs font-medium text-gray-700 dark:text-slate-300">{{ $church->name }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
                                        ...
                                        <div class="flex flex-col items-center gap-1">
                                            ...
                                            @elseif(!$data['is_readonly'])
                                                <input type="date" 
                                                    class="hidden" 
                                                    x-ref="date_{{ $key }}"
                                                    @change="toggle({{ $data['id'] }}, '{{ $data['row_id'] }}', {{ $data['is_member'] ? 'true' : 'false' }}, {{ $sunday['week_number'] }}, $event.target.value, 'clear')"
                                                >
                                                <button @click="$refs.date_{{ $key }}.showPicker()" 
                        ...
                        <tr>
                            <td colspan="{{ 2 + count($sundays) }}" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center gap-4 opacity-30">
                                    ...
                                    <p class="text-lg font-medium text-gray-500 dark:text-slate-400">No attendance records for newcomers in this church for this period.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
