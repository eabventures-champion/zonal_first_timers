...
@if($isAdmin)
    ...
    <p class="px-3 mt-5 mb-2 text-[10px] font-semibold uppercase tracking-widest text-slate-500">Church Hierarchy</p>
    ...
    <p class="px-3 mt-5 mb-2 text-[10px] font-semibold uppercase tracking-widest text-slate-500">People</p>
...
@if($isRO)
    ...
    <p class="px-3 mt-5 mb-2 text-[10px] font-semibold uppercase tracking-widest text-slate-500">My Church</p>
